#ifndef __CLASS_JAVA_LANG_ILLEGALSTATEEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_ILLEGALSTATEEXCEPTION_HEADER

struct java_lang_IllegalStateException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_IllegalStateException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_IllegalStateException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_IllegalStateException_serialVersionUID);
GC_STRUCT_END(java_lang_IllegalStateException_ClassStatic) java_lang_IllegalStateException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_IllegalStateException)
  GC_STRUCT_VAR(struct java_lang_IllegalStateException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_IllegalStateException) java_lang_IllegalStateException;

struct java_lang_IllegalStateException_MethodTblStruct {
...
extern struct java_lang_IllegalStateException_MethodTblStruct java_lang_IllegalStateException_MethodTbl ;
