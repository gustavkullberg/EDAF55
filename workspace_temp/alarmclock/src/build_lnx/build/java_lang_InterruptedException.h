#ifndef __CLASS_JAVA_LANG_INTERRUPTEDEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_INTERRUPTEDEXCEPTION_HEADER

struct java_lang_InterruptedException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_InterruptedException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_InterruptedException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_InterruptedException_serialVersionUID);
GC_STRUCT_END(java_lang_InterruptedException_ClassStatic) java_lang_InterruptedException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_InterruptedException)
  GC_STRUCT_VAR(struct java_lang_InterruptedException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_InterruptedException) java_lang_InterruptedException;

struct java_lang_InterruptedException_MethodTblStruct {
...
extern struct java_lang_InterruptedException_MethodTblStruct java_lang_InterruptedException_MethodTbl ;
