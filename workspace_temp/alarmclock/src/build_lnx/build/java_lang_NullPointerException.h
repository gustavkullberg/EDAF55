#ifndef __CLASS_JAVA_LANG_NULLPOINTEREXCEPTION_HEADER
#define __CLASS_JAVA_LANG_NULLPOINTEREXCEPTION_HEADER

struct java_lang_NullPointerException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_NullPointerException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_NullPointerException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_NullPointerException_serialVersionUID);
GC_STRUCT_END(java_lang_NullPointerException_ClassStatic) java_lang_NullPointerException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_NullPointerException)
  GC_STRUCT_VAR(struct java_lang_NullPointerException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_NullPointerException) java_lang_NullPointerException;

struct java_lang_NullPointerException_MethodTblStruct {
...
extern struct java_lang_NullPointerException_MethodTblStruct java_lang_NullPointerException_MethodTbl ;
