#ifndef __CLASS_JAVA_LANG_EXCEPTION_HEADER
#define __CLASS_JAVA_LANG_EXCEPTION_HEADER

struct java_lang_Exception_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_Exception_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_Exception_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_Exception_serialVersionUID);
GC_STRUCT_END(java_lang_Exception_ClassStatic) java_lang_Exception_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_Exception)
  GC_STRUCT_VAR(struct java_lang_Exception_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_Exception) java_lang_Exception;

struct java_lang_Exception_MethodTblStruct {
...
extern struct java_lang_Exception_MethodTblStruct java_lang_Exception_MethodTbl ;
