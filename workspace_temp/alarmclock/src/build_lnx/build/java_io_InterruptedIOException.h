#ifndef __CLASS_JAVA_IO_INTERRUPTEDIOEXCEPTION_HEADER
#define __CLASS_JAVA_IO_INTERRUPTEDIOEXCEPTION_HEADER

struct java_io_InterruptedIOException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_io_InterruptedIOException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_io_InterruptedIOException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_io_InterruptedIOException_serialVersionUID);
GC_STRUCT_END(java_io_InterruptedIOException_ClassStatic) java_io_InterruptedIOException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_io_InterruptedIOException)
  GC_STRUCT_VAR(struct java_io_InterruptedIOException_ClassStruct *,class);
  ...
  volatile GC_STRUCT_VAR(JInt,_java_io_InterruptedIOException_bytesTransferred);
GC_STRUCT_END(java_io_InterruptedIOException) java_io_InterruptedIOException;

struct java_io_InterruptedIOException_MethodTblStruct {
...
extern struct java_io_InterruptedIOException_MethodTblStruct java_io_InterruptedIOException_MethodTbl ;
