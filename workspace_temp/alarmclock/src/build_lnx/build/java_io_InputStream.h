#ifndef __CLASS_JAVA_IO_INPUTSTREAM_HEADER
#define __CLASS_JAVA_IO_INPUTSTREAM_HEADER

struct java_io_InputStream_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_io_InputStream_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_io_InputStream_ClassStatic)
  /* static fields go here, from this class and its ancestors */
GC_STRUCT_END(java_io_InputStream_ClassStatic) java_io_InputStream_ClassStatic;

typedef GC_STRUCT_BEGIN(java_io_InputStream)
  GC_STRUCT_VAR(struct java_io_InputStream_ClassStruct *,class);
  volatile GC_STRUCT_VAR(JBoolean,_java_lang_Object_interruptedFlag);
GC_STRUCT_END(java_io_InputStream) java_io_InputStream;

struct java_io_InputStream_MethodTblStruct {
  ...
  JInt (*read)(void **__eFlag__, GC_PARAM(java_io_InputStream,this));
...
extern struct java_io_InputStream_MethodTblStruct java_io_InputStream_MethodTbl ;
