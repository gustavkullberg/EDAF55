#ifndef __CLASS_JAVA_LANG_ARRAYINDEXOUTOFBOUNDSEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_ARRAYINDEXOUTOFBOUNDSEXCEPTION_HEADER

struct java_lang_ArrayIndexOutOfBoundsException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_ArrayIndexOutOfBoundsException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_ArrayIndexOutOfBoundsException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_ArrayIndexOutOfBoundsException_serialVersionUID);
GC_STRUCT_END(java_lang_ArrayIndexOutOfBoundsException_ClassStatic) java_lang_ArrayIndexOutOfBoundsException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_ArrayIndexOutOfBoundsException)
  GC_STRUCT_VAR(struct java_lang_ArrayIndexOutOfBoundsException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_ArrayIndexOutOfBoundsException) java_lang_ArrayIndexOutOfBoundsException;

struct java_lang_ArrayIndexOutOfBoundsException_MethodTblStruct {
...
extern struct java_lang_ArrayIndexOutOfBoundsException_MethodTblStruct java_lang_ArrayIndexOutOfBoundsException_MethodTbl ;
