#ifndef __CLASS_JAVA_LANG_INDEXOUTOFBOUNDSEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_INDEXOUTOFBOUNDSEXCEPTION_HEADER

struct java_lang_IndexOutOfBoundsException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_IndexOutOfBoundsException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_IndexOutOfBoundsException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_IndexOutOfBoundsException_serialVersionUID);
GC_STRUCT_END(java_lang_IndexOutOfBoundsException_ClassStatic) java_lang_IndexOutOfBoundsException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_IndexOutOfBoundsException)
  GC_STRUCT_VAR(struct java_lang_IndexOutOfBoundsException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_IndexOutOfBoundsException) java_lang_IndexOutOfBoundsException;

struct java_lang_IndexOutOfBoundsException_MethodTblStruct {
...
extern struct java_lang_IndexOutOfBoundsException_MethodTblStruct java_lang_IndexOutOfBoundsException_MethodTbl ;
