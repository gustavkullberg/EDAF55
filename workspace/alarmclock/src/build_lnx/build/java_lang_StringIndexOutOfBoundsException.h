#ifndef __CLASS_JAVA_LANG_STRINGINDEXOUTOFBOUNDSEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_STRINGINDEXOUTOFBOUNDSEXCEPTION_HEADER

struct java_lang_StringIndexOutOfBoundsException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_StringIndexOutOfBoundsException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_StringIndexOutOfBoundsException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_StringIndexOutOfBoundsException_serialVersionUID);
GC_STRUCT_END(java_lang_StringIndexOutOfBoundsException_ClassStatic) java_lang_StringIndexOutOfBoundsException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_StringIndexOutOfBoundsException)
  GC_STRUCT_VAR(struct java_lang_StringIndexOutOfBoundsException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_StringIndexOutOfBoundsException) java_lang_StringIndexOutOfBoundsException;

struct java_lang_StringIndexOutOfBoundsException_MethodTblStruct {
...
extern struct java_lang_StringIndexOutOfBoundsException_MethodTblStruct java_lang_StringIndexOutOfBoundsException_MethodTbl ;
