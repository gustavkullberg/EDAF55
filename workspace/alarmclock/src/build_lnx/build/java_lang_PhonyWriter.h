#ifndef __CLASS_JAVA_LANG_PHONYWRITER_HEADER
#define __CLASS_JAVA_LANG_PHONYWRITER_HEADER

struct java_lang_PhonyWriter_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_PhonyWriter_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_PhonyWriter_ClassStatic)
  /* static fields go here, from this class and its ancestors */
GC_STRUCT_END(java_lang_PhonyWriter_ClassStatic) java_lang_PhonyWriter_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_PhonyWriter)
  GC_STRUCT_VAR(struct java_lang_PhonyWriter_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_PhonyWriter) java_lang_PhonyWriter;

struct java_lang_PhonyWriter_MethodTblStruct {
  ...
  void (*flush)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this));
  ...
  void (*print_boolean)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JBoolean i);
  void (*print_int)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JInt i);
  void (*print_long)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JLong i);
  void (*print_float)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JFloat i);
  void (*print_double)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JDouble i);
  void (*print_java_lang_Object)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),GC_PARAM(java_lang_Object,obj));
  void (*print_java_lang_String)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),GC_PARAM(java_lang_String,s));
  void (*print_char)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JChar i);
  void (*print_charA)(void **__eFlag__, GC_PARAM(java_io_PrintStream,this),GC_PARAM(JCharArray,charArray));
  void (*println)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this));
  void (*println_boolean)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JBoolean i);
  void (*println_int)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JInt i);
  void (*println_long)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JLong i);
  void (*println_float)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JFloat i);
  void (*println_double)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JDouble i);
  void (*println_java_lang_Object)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),GC_PARAM(java_lang_Object,obj));
  void (*println_java_lang_String)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),GC_PARAM(java_lang_String,s));
  void (*println_char)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JChar i);
  void (*println_charA)(void **__eFlag__, GC_PARAM(java_io_PrintStream,this),GC_PARAM(JCharArray,charArray));
  void (*print)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this));
  void (*print_short)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JShort i);
  void (*println_short)(void **__eFlag__, GC_PARAM(java_lang_PhonyWriter,this),JShort i);
};
extern struct java_lang_PhonyWriter_MethodTblStruct java_lang_PhonyWriter_MethodTbl ;
