#ifndef __CLASS_JAVA_LANG_THROWABLE_HEADER
#define __CLASS_JAVA_LANG_THROWABLE_HEADER

struct java_lang_Throwable_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_Throwable_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_Throwable_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_Throwable_serialVersionUID);
GC_STRUCT_END(java_lang_Throwable_ClassStatic) java_lang_Throwable_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_Throwable)
  GC_STRUCT_VAR(struct java_lang_Throwable_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_Throwable) java_lang_Throwable;

struct java_lang_Throwable_MethodTblStruct {
...
extern struct java_lang_Throwable_MethodTblStruct java_lang_Throwable_MethodTbl ;
