#ifndef __CLASS_JAVA_LANG_ILLEGALARGUMENTEXCEPTION_HEADER
#define __CLASS_JAVA_LANG_ILLEGALARGUMENTEXCEPTION_HEADER

struct java_lang_IllegalArgumentException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_lang_IllegalArgumentException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_lang_IllegalArgumentException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_lang_IllegalArgumentException_serialVersionUID);
GC_STRUCT_END(java_lang_IllegalArgumentException_ClassStatic) java_lang_IllegalArgumentException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_lang_IllegalArgumentException)
  GC_STRUCT_VAR(struct java_lang_IllegalArgumentException_ClassStruct *,class);
...
GC_STRUCT_END(java_lang_IllegalArgumentException) java_lang_IllegalArgumentException;

struct java_lang_IllegalArgumentException_MethodTblStruct {
...
extern struct java_lang_IllegalArgumentException_MethodTblStruct java_lang_IllegalArgumentException_MethodTbl ;
