#ifndef __CLASS_JAVA_IO_IOEXCEPTION_HEADER
#define __CLASS_JAVA_IO_IOEXCEPTION_HEADER

struct java_io_IOException_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct java_io_IOException_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(java_io_IOException_ClassStatic)
  /* static fields go here, from this class and its ancestors */
  volatile GC_STRUCT_VAR(JLong,_java_io_IOException_serialVersionUID);
GC_STRUCT_END(java_io_IOException_ClassStatic) java_io_IOException_ClassStatic;

typedef GC_STRUCT_BEGIN(java_io_IOException)
  GC_STRUCT_VAR(struct java_io_IOException_ClassStruct *,class);
...
GC_STRUCT_END(java_io_IOException) java_io_IOException;

struct java_io_IOException_MethodTblStruct {
...
extern struct java_io_IOException_MethodTblStruct java_io_IOException_MethodTbl ;
